...
struct GlobalConstants
{
    ...
    static let AKCoderToDoGray1 = Func.AKHexColor(0x353A3C)
    static let AKCoderToDoGray2 = Func.AKHexColor(0x41474A)
    static let AKCoderToDoWhite1 = Func.AKHexColor(0xD9D9D6)
    static let AKCoderToDoWhite2 = Func.AKHexColor(0xC9C9C6)
    static let AKCoderToDoWhite3 = Func.AKHexColor(0xB9B9B6) // Don't use this one.
    // ### Custom Color Palette:
    ...
    static let AKDefaultBg = GlobalConstants.AKCoderToDoWhite1
    static let AKDefaultFg = GlobalConstants.AKCoderToDoGray1
    static let AKTabBarBg = GlobalConstants.AKCoderToDoWhite2
    ...
    static let AKBadgeColorBg = GlobalConstants.AKCoderToDoGray2
    static let AKBadgeColorFg = GlobalConstants.AKCoderToDoWhite2
